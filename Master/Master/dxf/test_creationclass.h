...
public:
    Test_CreationClass(const std::vector<std::string>& titleList, const std::string& key, const std::string& value/*, const char* filename*/);
	~Test_CreationClass();
	...
	// 创建明细表
	const std::vector<Table*>& createTable(void);
	// 保存明细表的内容到文本
